  ...
  describe '#create' do
    context 'with no user sign in' do
      it 'redirects to the sign in page' do
        ...
        post :create, params: {
          product_id: product.id, review: FactoryGirl.attributes_for(:review)}
    ...
    before { request.session[:user_id] = user.id }
      context 'with valid attributes' do
        def valid_request
          post :create, params: {product_id: product.id, review: FactoryGirl.attributes_for(:review)}
        end
      ...
      context 'with invalid attributes' do
        def invalid_request
          post :create, params: {product_id: product.id, review: FactoryGirl.attributes_for(:review, body: nil)}
        end
